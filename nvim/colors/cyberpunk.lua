...
hl("Pmenu",         { fg = "#d3d3d3", bg = "#1a1a1a" })
hl("PmenuSel",      { fg = "#ffffff", bg = "#7f073f", bold = true })
hl("PmenuSbar",     { bg = "#1a1a1a" })
hl("PmenuThumb",    { bg = "#4c83ff" })
hl("PmenuKind",     { fg = "#ff69b4", bg = "#1a1a1a" })
hl("PmenuKindSel",  { fg = "#ff69b4", bg = "#7f073f", bold = true })
hl("PmenuExtra",    { fg = "#8b8989", bg = "#1a1a1a" })
hl("PmenuExtraSel", { fg = "#8b8989", bg = "#7f073f", bold = true })

hl("NormalFloat",   { fg = "#d3d3d3", bg = "#1a1a1a" })
hl("FloatBorder",   { fg = "#4c83ff", bg = "#1a1a1a" })
hl("FloatTitle",    { fg = "#ff1493", bg = "#1a1a1a", bold = true })

hl("CmpItemAbbr",           { fg = "#d3d3d3", bg = "NONE" })
hl("CmpItemAbbrDeprecated", { fg = "#6f6f6f", strikethrough = true })
hl("CmpItemAbbrMatch",      { fg = "#ffff00", bold = true })
hl("CmpItemAbbrMatchFuzzy", { fg = "#fbde2d", bold = true })
hl("CmpItemMenu",           { fg = "#8b8989", italic = true })
hl("CmpItemKindFunction",   { fg = "#ff1493" })
hl("CmpItemKindMethod",     { fg = "#ff1493" })
hl("CmpItemKindVariable",   { fg = "#ff69b4" })
hl("CmpItemKindField",      { fg = "#ff69b4" })
hl("CmpItemKindClass",      { fg = "#afd8af" })
hl("CmpItemKindInterface",  { fg = "#afd8af" })
hl("CmpItemKindStruct",     { fg = "#afd8af" })
hl("CmpItemKindModule",     { fg = "#919191" })
hl("CmpItemKindKeyword",    { fg = "#4c83ff" })
hl("CmpItemKindSnippet",    { fg = "#61ce3c" })
hl("CmpItemKindText",       { fg = "#d3d3d3" })
